...
class AgentRuntime:
    ...
    def tool_config(self, *, run_id: str, principal: Principal) -> ToolExecutionConfig:
        ...
        return ToolExecutionConfig(runtime=self.execution, policy=self.policy,
            principal=principal, approval_store=self.approvals,
            idempotency_store=self.idempotency, run_id=run_id)
